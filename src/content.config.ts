...
const blog = defineCollection({
  ...
  schema: ({ image }) => z.object({
    ...
    // Module 31 (author entity): fill these ONLY when a post has a real
    // named writer with a genuine bio/profile URL — activates Person
    // schema in SEOHead.astro. Leave unset for team-authored posts; the
    // Organization fallback stays honest instead of inventing a byline.
