...
<div style="max-width:520px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.1);">
  ...
  <div style="padding:28px 24px;">
    ...
    <div style="background:#f8fafc;border-radius:10px;padding:16px;margin:16px 0;border-left:4px solid #f59e0b;">
      ...
      <p style="margin:4px 0 0;font-size:.75rem;color:#9ca3af;">Use this ID to track your move at <a href="https://www.packershub.in/track/">www.packershub.in/track/</a></p>
    </div>
    <div style="margin:20px 0;">
      ...
      <a href="https://wa.me/917731074075?text=${encodeURIComponent('Hi, my tracking ID is ' + p.trackingId)}" style="display:inline-block;background:#25d366;color:#fff;font-weight:bold;text-decoration:none;border-radius:8px;padding:12px 24px;">💬 WhatsApp</a>
    </div>
    <p style="color:#9ca3af;font-size:.75rem;margin-top:20px;">PackersHub · BV Nagar, Nellore, Andhra Pradesh · <a href="https://www.packershub.in">www.packershub.in</a></p>
  </div>
</div>
</body></html>`;
}
...
<div style="max-width:520px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.1);">
  ...
  <div style="padding:24px;">
    ...
    <div style="margin:16px 0;">
      ...
      <a href="https://wa.me/917731074075?text=${encodeURIComponent('Hi, regarding booking ' + p.trackingId)}" style="display:inline-block;background:#25d366;color:#fff;font-weight:bold;text-decoration:none;border-radius:8px;padding:10px 20px;font-size:.85rem;">💬 WhatsApp</a>
    </div>
